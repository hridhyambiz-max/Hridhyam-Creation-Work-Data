...
function renderShell() {
  ...
  $(".logout").onclick = () => { state.role = null; state.userId = null; state.unsub.forEach((u) => u()); state.unsub = []; renderLogin(); };
  renderView();
}
